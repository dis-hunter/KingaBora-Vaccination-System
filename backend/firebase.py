        ...
        for doc in docs:
            ...
            if doc_next_visit:
                ...
                if doc_utc_datetime <= utc_datetime:
                    ...
                    if isinstance(vaccines_issued, list):
                        # Log each vaccine item
                        logging.info(f"Vaccines issued for {doc.id}: {vaccines_issued}")
                        
                    else:
                        # Default to an empty list if not an array
                        vaccines_issued = []
